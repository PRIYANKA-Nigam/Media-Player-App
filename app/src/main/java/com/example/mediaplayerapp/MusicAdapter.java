...
if (mediaPlayer.isPlaying()){
    mediaPlayer.pause();
    viewHolder.play.setImageResource(R.drawable.ic_baseline_play_arrow_24);
}
else {
    mediaPlayer.start();
    viewHolder.play.setImageResource(R.drawable.ic_baseline_pause_circle_filled_24);
}
mediaPlayer.start();
            }
        });
viewHolder.pause.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        viewHolder.pause.setImageResource(R.drawable.ic_baseline_web_asset_24);
    }
});
return convertView;
    }
